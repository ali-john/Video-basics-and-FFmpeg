...
# Quantize (reduce data by 10 )the transformed coefficients

quantizied = numpy.round(coefficients/10).astype(int)
# write quantized image
rec = scipy.fftpack.idct(scipy.fftpack.idct(coefficients.T, norm="ortho").T, norm="ortho")
cv2.imwrite("QuantizedResult.png",rec)
